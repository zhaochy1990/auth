...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/users/me/accounts/{provider_id}/authorize": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Provider id (e.g. coros)",
                        "name": "provider_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.authorizeAccountRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.authorizeAccountResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/users/me/phone": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Phone and verification code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.phoneBindRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/oauth/link/{provider_id}/callback": {
            "get": {
                "tags": [
                    "oauth"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Opaque state handle",
                        "name": "state",
                        "in": "query",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "internal_handlers.authorizeAccountRequest": {
            "type": "object",
            "properties": {
                "redirect_uri": {
                    "type": "string"
        ...
        "internal_handlers.authorizeAccountResponse": {
            "type": "object",
            "properties": {
                "authorize_url": {
                    "type": "string"
        ...
        "internal_handlers.phoneBindRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
