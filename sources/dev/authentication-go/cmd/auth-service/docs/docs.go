...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/auth/wechat-bind": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "WeChat code + email + password",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.wechatBindRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.wechatLoginResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.wechatLoginRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handlers.wechatBindRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_handlers.wechatLoginRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_handlers.wechatLoginResponse": {
            "type": "object",
            "properties": {
                "access_token": {
                    "type": "string"
                ...
                "user": {
                    "$ref": "#/definitions/internal_handlers.wechatUserResponse"
                }
            }
        },
        "internal_handlers.wechatUserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
